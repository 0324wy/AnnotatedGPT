...
dataset = load_dataset("wikitext", "wikitext-2-v1")
test_list = dataset['test']['text'][50:51]
...
b = collate_fn(test_list)


greedy_decode(model, b[0], 8, vocab)
...
# for _src in test_list:
#     print(_src)
#     x = torch.tensor(vocab(tokenize_en(_src)), dtype=torch.int64, device=device)
#     x = x.unsqueeze(0)
#     batch = Batch(x, x)
