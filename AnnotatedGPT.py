...
Original file is located at
    https://colab.research.google.com/drive/1Zq-hZU2b7pyWyM3pv-eh-x4nXoTDk5Fc
"""
...
class Batch:
    ...
    def __init__(self, src, pad=2):  # 2 = <blank>
        self.src = src[:, :-1]
        self.src_y = src[:, 1:]
        self.mask = self.make_std_mask(self.src, pad)
        self.ntokens = (self.src_y != pad).data.sum()
